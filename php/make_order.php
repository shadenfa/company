...
<nav class="navbar navbar-inverse">
   ...
   <br />
     <p align="right">Hi - <?php echo $_SESSION['username'];  ?> <br><br>
	 <h4 align="left">    to make an order  please choose the type and quantity: </h4>
   <div class="col-sm-6">
			...
			<form class="form-horizontal" method="post">
			  ...
			  <div class="form-group" >
				...
				<div class="col-sm-9"> 
				   <select  class="form-control" id="Type" required name="Type">
                    ...
                    $qry="SELECT * FROM resourses ";
                    $result=mysqli_query($con,$qry);

                    if($result){
                      while ($info=mysqli_fetch_array($result)) {
                    print "  <option value=" .$info['id']. ">".$info['type']. " </option>";
                    }
                   }
                    ?>
                </select>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9"> 
				  <input type="number" class="form-control" id="Quantity" required placeholder="Quantity" name="Quantity">
				</div>
			  </div>
			  ...
			  <div class="form-group"> 
				<div class="col-sm-offset-3 col-sm-9">
				  <a href="#"><button type="submit" class="btn btn-default" name="order">Make Order</button></a>
				</div>
			  </div>
			</form>
		</div>
...
//$HR_id = mysqli_real_escape_string( $con ,$_POST['HR']) ;  
$emp_id=$_SESSION['a_id'];
	$qry="INSERT INTO  orders (emp_id,orders,quantity,state_name) VALUES ('$emp_id','$type' ,'$quantity',2);"; 
	 mysqli_query($con,$qry);  
			  		 
	echo "<script>{document.location.href='make_order.php'};</script> ";
