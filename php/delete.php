...
<nav class="navbar navbar-inverse">
  ...
  <form class="navbar-form navbar-right"  action="search.php"  method="POST">
	...
	<div class="panel-heading"><h2>Delete Employee </h2></div>
		...
		<div class="col-sm-6">
			<form class="form-horizontal" method="post">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9"> 
				  <input type="text" class="form-control" id="description" required placeholder="description" name="description">
				</div>
			  </div>
			  <div class="form-group">
				<label class="control-label col-sm-3">EXT:</label>
				<div class="col-sm-9"> 
				  <input type="text" class="form-control" id="EXT" required placeholder="EXT" name="EXT">
				</div>
			  </div>
			  <div class="form-group"> 
				<div class="col-sm-offset-3 col-sm-9">
				  <button type="submit" class="btn btn-default" name="Delete" onclick="getConfirmation();" />Delete</button>
				</div>
			  </div>
			  <div class="form-group"> 
				<div class="col-sm-offset-3 col-sm-9">
  ...
  if (isset($_POST['Delete'])) 
	...
	{
		 $id=$info['a_id'];
         $sql= "DELETE from add_employees WHERE a_id ='$id' ;";
