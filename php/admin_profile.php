...
print "<div id='i'><div class='jumbotron' style='border:1.5px solid black'>
			 ...
			 <a href='permissions-admin.php'><button type='button' class='btn btn-default  btn-lg ' name='button'>Permmisions</button></a>
			<a href='chat.php'><button type='button' class='btn btn-default  btn-lg ' name='button'>Direct message</button></a>
			<a href='make_order.php'><button type='button' class='btn btn-default  btn-lg ' name='button'>Make Order</button></a>
				</div>";
...
<br>
 ...
 <?php
 $id=$_GET['id'];
 $qry="SELECT * FROM orders,resourses where  emp_id='$id' and  id=orders ";

$result=mysqli_query($con,$qry);

$output = '<h4  >Your Orders:</h4> <table class="table table-bordered table-striped">
 <tr>
